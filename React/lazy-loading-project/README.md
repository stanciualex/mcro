...
- `create-react-app` is a global command-line utility.js that you use to create new projects.
...
Named exports are useful for utility.js modules that export several functions. A module may have at most one default export and as many named exports as you like.
